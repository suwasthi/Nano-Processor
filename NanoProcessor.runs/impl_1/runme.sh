...
HD_PWD='C:/Users/Suwas/NanoProcessor/NanoProcessor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Featured_Nano_Processor_with_7Seg.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Featured_Nano_Processor_with_7Seg.tcl -notrace
