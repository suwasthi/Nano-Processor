...
HD_PWD='C:/Users/Suwas/NanoProcessor/NanoProcessor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Featured_Nano_Processor_with_7Seg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Featured_Nano_Processor_with_7Seg.tcl
